...
namespace AutoRest.Ruby.Haipa.Model
{
    ...
    public class MethodRba : MethodRb
    {
        ...
        public string AssignNextMethodToPage()
        {
            ...
            var origName = DependencyInjection.Singleton<CodeNamerRb>.Instance.UnderscoreCase(Name.RawValue);
            ...
            MethodRba nextMethodTemplateModel = DependencyInjection.New<MethodRba>().LoadFrom(nextMethod);
        ...
        public MethodRba GetMethod
        {
            get
            {
                ...
                return DependencyInjection.New<MethodRba>().LoadFrom(getMethod);
            }
        }
        ...
        public override string OperationResponseReturnTypeString
        {
            get
            {
                return "Haipa::Client::HaipaOperationResponse";
            }
        }
        ...
        public override string OperationExceptionTypeString
        {
            get
            {
                ...
                {
                    return "Haipa::Client::HaipaOperationError";
                }
