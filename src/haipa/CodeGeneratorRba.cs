...
namespace AutoRest.Ruby.Haipa
{
    ...
    public class CodeGeneratorRba : CodeGeneratorRb
    {
        ...
        /// </summary>
        public override string UsageInstructions => @"The ""gem 'haipa_rest' ~> 0.7"" is required for working with generated code.";
        ...
        public override async Task Generate(CodeModel cm)
        {
            ...
            if (codeModel == null)
            {
                throw new InvalidCastException("CodeModel is not a Haipa Ruby code model.");
            }
            ...
            {
                // Operation
                var operationsTemplate = new HaipaMethodGroupTemplate { Model = group };
